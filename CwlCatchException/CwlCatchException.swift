...
private func catchReturnTypeConverter<T: NSException>(t: T.Type, block: () -> Void) -> T? {
	return catchExceptionOfType(t, block) as? T
}

extension NSException {
	public static func catchException(block: () -> Void) -> Self? {
